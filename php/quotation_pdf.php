...
//generating pdf
	...
	//first line(logo and quoatation text)
		...
		$image1 = "../img/logo.jpg";
		$pdf->Cell( 70, 30, $pdf->Image($image1, 10, 10, 40, 30), 0, 0, 'L', false );
		//$pdf->Image("../img/logo.jpg", 10, 10, 40, 30, "JPG");

		$pdf->SetFont('Arial', 'B', 20); //font
		$pdf->SetTextColor(204,0,0); //text color //red
		$pdf->Cell(119, 30, 'Quotation / PERFORMA Invoice', 0, 1); //end of line
	...
	//Totaling up line (Purchased Item heading)
		...
		$pdf->Cell(30, 7, $total_amount, 1, 0);

	$pdf->Output();
	//$pdf->Output('D','Quotation-' . $quotation_num. '.pdf');	
