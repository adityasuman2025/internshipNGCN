...
<!----------script------------>		
	...
	//on clicking on user edit icon
		$('.user_edit_icon').click(function()
		{
			...
			if(type =='service')
			{
				$.post('php/edit_service_quotation.php', {quotation_num: quotation_num}, function(data)
				{
			...
			{
				$.post('php/edit_sales_quotation.php', {quotation_num: quotation_num}, function(data)
				{
					$('.user_module_content').html("<img class=\"gif_loader\" src=\"img/loaders1.gif\">").html(data);	
				});	
			}
